...
<head>
    ...
    <title>Casting Performance - ALPC 3SZ</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <div class="filter-section" style="margin-bottom: 12px; gap: 8px; display: flex; flex-wrap: wrap; align-items: center;">
                ...
                <span style="padding: 4px 14px; font-size: 12px; font-weight: 700; border-radius: 20px; background: linear-gradient(135deg, #2980b9 0%, #1a6fa0 100%); color: #fff;">LPC 9</span>
    ...
    <div class="c-hist-overlay" id="c-hist-overlay" onclick="if(event.target===this)castingHistory.close()">
        <div class="c-hist-modal">
            <div class="c-hist-header">
                <div>
                    <h2>📋 Casting Temperature History — ALPC 3SZ</h2>
                    <p>Temperature records from database | LPC 9 | Select date to view data</p>
                </div>
    ...
    const castingHistory = {
        ...
        async load() {
            ...
            try {
                ...
                if (json.status === 'success' && json.data?.length) {
                    ...
                    meta.textContent = `${json.data.length} records — LPC 9 | ${date} | ${shift === 'all' ? 'All Shifts' : shift}`;
        ...
        download() {
            ...
            a.download = `casting-3sz-lpc9-${date}.csv`;
            a.click();
        }
    };
    </script>
