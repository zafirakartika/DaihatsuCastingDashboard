...
<head>
    ...
    <title>Finishing 1 Performance - ALPC KR</title>
...
<div class="performance-content">
    <div class="status-bar" id="statusBar">
        <div class="machine-status">
            ...
            <div>
                <div class="machine-name">Finishing Machine 1 - KR Line</div>
    ...
    <div class="kpi-grid">
        <div class="kpi-card success"><div class="kpi-label">Parts Processed</div><div class="kpi-value" id="parts-processed">0</div><div class="kpi-trend up" id="parts-trend"><span>&#x2191;</span><span>+12 vs yesterday</span></div></div>
        <div class="kpi-card"><div class="kpi-label">Cycle Time</div><div class="kpi-value"><span id="cycle-time">0</span><span class="kpi-unit">sec</span></div><div class="kpi-trend" id="cycle-trend"><span>Target: 45s</span></div></div>
        <div class="kpi-card success"><div class="kpi-label">First Pass Yield</div><div class="kpi-value"><span id="fpy">0</span><span class="kpi-unit">%</span></div><div class="kpi-trend up" id="fpy-trend"><span>&#x2191; 2.3%</span></div></div>
        <div class="kpi-card success"><div class="kpi-label">Machine Uptime</div><div class="kpi-value"><span id="uptime">0</span><span class="kpi-unit">%</span></div><div class="kpi-trend" id="uptime-trend"><span>8h 42m running</span></div></div>
        <div class="kpi-card"><div class="kpi-label">Oven Temperature</div><div class="kpi-value"><span id="oven-temp">0</span><span class="kpi-unit">&#xB0;C</span></div><div class="kpi-trend" id="temp-trend"><span>Target: 180-200&#xB0;C</span></div></div>
        <div class="kpi-card warning"><div class="kpi-label">Defect Rate</div><div class="kpi-value"><span id="defect-rate">0</span><span class="kpi-unit">%</span></div><div class="kpi-trend down" id="defect-trend"><span>&#x2193; 0.8%</span></div></div>
    </div>
    ...
    <div class="charts-row">
        <div class="chart-container"><div class="chart-header"><div class="chart-title">Pressure &amp; Speed Monitoring</div></div><div class="chart-canvas"><canvas id="pressureSpeedChart"></canvas></div></div>
        <div class="chart-container"><div class="chart-header"><div class="chart-title">Cycle Time &amp; Throughput</div></div><div class="chart-canvas"><canvas id="cycleTimeChart"></canvas></div></div>
    </div>
    <div class="charts-row">
        <div class="chart-container"><div class="chart-header"><div class="chart-title">Defect Distribution</div></div><div class="chart-canvas"><canvas id="defectDistributionChart"></canvas></div></div>
        <div class="chart-container"><div class="chart-header"><div class="chart-title">Hourly Performance Pattern</div></div><div class="chart-canvas"><canvas id="hourlyPerformanceChart"></canvas></div></div>
    </div>
    <div class="process-table">
        <div class="table-header">Current Process Parameters</div>
        <table>
            <thead><tr><th>Parameter</th><th>Current Value</th><th>Target Range</th><th>Unit</th><th>Status</th></tr></thead>
            <tbody id="processTableBody">
                <tr><td class="param-name">Oven Temperature</td><td class="param-current" id="param-oven-temp">--</td><td class="param-target">180 - 200</td><td>&#xB0;C</td><td><span class="status-badge status-normal">Normal</span></td></tr>
                <tr><td class="param-name">Cooling Temperature</td><td class="param-current" id="param-cooling-temp">--</td><td class="param-target">25 - 35</td><td>&#xB0;C</td><td><span class="status-badge status-normal">Normal</span></td></tr>
                <tr><td class="param-name">Coating Pressure</td><td class="param-current" id="param-pressure">--</td><td class="param-target">2.5 - 3.5</td><td>bar</td><td><span class="status-badge status-normal">Normal</span></td></tr>
                <tr><td class="param-name">Conveyor Speed</td><td class="param-current" id="param-speed">--</td><td class="param-target">1.2 - 1.5</td><td>m/min</td><td><span class="status-badge status-normal">Normal</span></td></tr>
                <tr><td class="param-name">Humidity Level</td><td class="param-current" id="param-humidity">--</td><td class="param-target">40 - 60</td><td>%</td><td><span class="status-badge status-normal">Normal</span></td></tr>
                <tr><td class="param-name">Vibration Level</td><td class="param-current" id="param-vibration">--</td><td class="param-target">&lt; 5</td><td>mm/s</td><td><span class="status-badge status-normal">Normal</span></td></tr>
            </tbody>
        </table>
    </div>
    <div class="process-table">
        ...
        <table>
            <thead><tr><th>Time</th><th>Batch ID</th><th>Cycle Time</th><th>Coating Thickness</th><th>Surface Quality</th><th>Status</th><th>Defect Type</th></tr></thead>
    ...
    <script src="{{ asset('js/finishing-performance-kr.js') }}"></script>
</body>
</html>
