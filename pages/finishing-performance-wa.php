...
<style>
    ...
    .defect-badge.coating {
        background: #fff3e0;
        color: #e65100;
    }

    .defect-badge.contamination {
        background: #fff9c4;
        color: #f57f17;
    }
...
<div class="performance-content">
    ...
    <div class="kpi-grid">
        <div class="kpi-card success">
            ...
            <div class="kpi-trend up" id="parts-trend">
                <span>↑</span>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value">
                <span id="cycle-time">0</span>
                <span class="kpi-unit">sec</span>
            </div>
            <div class="kpi-trend" id="cycle-trend">
                <span>Target: 45s</span>
            </div>
        </div>
        ...
        <div class="kpi-card success">
            ...
            <div class="kpi-trend up" id="fpy-trend">
                <span>↑ 2.3%</span>
            </div>
        </div>
        ...
        <div class="kpi-card success">
            ...
            <div class="kpi-trend" id="uptime-trend">
                <span>8h 42m running</span>
            </div>
        </div>
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value">
                <span id="oven-temp">0</span>
                <span class="kpi-unit">°C</span>
            </div>
            <div class="kpi-trend" id="temp-trend">
                <span>Target: 180-200°C</span>
            </div>
        </div>
        ...
        <div class="kpi-card warning">
            ...
            <div class="kpi-value">
                <span id="defect-rate">0</span>
                <span class="kpi-unit">%</span>
            </div>
            <div class="kpi-trend down" id="defect-trend">
                <span>↓ 0.8%</span>
            </div>
        </div>
    </div>
    ...
    <!-- Pressure & Speed + Cycle Time Charts -->
    <div class="charts-row">
        <div class="chart-container">
            <div class="chart-header">
                <div class="chart-title">Pressure & Speed Monitoring</div>
            </div>
            <div class="chart-canvas">
                <canvas id="pressureSpeedChart"></canvas>
            </div>
        </div>

        <div class="chart-container">
            <div class="chart-header">
                <div class="chart-title">Cycle Time & Throughput</div>
            </div>
            <div class="chart-canvas">
    ...
    <!-- Defect Distribution + Hourly Performance -->
    <div class="charts-row">
        <div class="chart-container">
            <div class="chart-header">
    ...
    <script>
        ...
        function toggleSubmenu(menuId) {
            ...
            const expandIcon = document.getElementById('expand-' + menuId);
    ...
    <script src="../js/finishing-performance-wa.js"></script>
</body>
</html>
