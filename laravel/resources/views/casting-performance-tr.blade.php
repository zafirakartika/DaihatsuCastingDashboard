...
<body>
    ...
    <div class="c-hist-overlay" id="c-hist-overlay" onclick="if(event.target===this)castingHistory.close()">
        <div class="c-hist-modal">
            <div class="c-hist-header">
                <div>
                    <h2>📋 Casting Temperature History — ALPC TR</h2>
    ...
    const castingHistory = {
        ...
        open() {
            ...
            if (activeLpc && histLpc) histLpc.value = activeLpc;
        ...
        async load() {
            ...
            const lpc = document.getElementById('hist-lpc')?.value || 2;
        ...
        download() {
            ...
            a.download = `casting-tr-lpc${lpc}-${date}.csv`;
            a.click();
        }
    };
    </script>
