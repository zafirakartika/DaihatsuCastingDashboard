<?php
$current_page = 'casting-performance-wa';
$base_url = '../';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <script src="../js/casting-performance-wa-config.js?v=<?php echo time(); ?>"></script>
    <script>
        ...
        // On page load, set to current shift (init() is already called by config file)
        ...
        function toggleRealTimeMonitoring() {
            ...
            if (isRealTimeEnabled) {
                ...
                refreshStatus.textContent = '2s';

                // Reload data which will restart simulation automatically
                CastingPerformance.loadAllData();
                console.log('✅ Real-time simulation ENABLED - reloading data');
            } else {
                // Turn OFF - Red
