...
<body>
            ...
            <div class="modal-body">
                ...
                <div class="modal-details-section">
                    <div class="detail-row">
                        <div class="detail-col"><label>Part ID:</label><span id="detail-id-part"></span></div>
                        <div class="detail-col"><label>Shot:</label><span id="detail-shot"></span></div>
                        <div class="detail-col"><label>LPC:</label><span id="detail-lpc"></span></div>
                        <div class="detail-col"><label>Shift:</label><span id="detail-shift"></span></div>
                        <div class="detail-col"><label>Judge:</label><span id="detail-judge" class="judge-badge">OK</span></div>
                    </div>
                </div>
                <div class="modal-table-section">
                    <table class="process-table">
                        <thead><tr><th>PROCESS NAME</th><th>JUDGE</th></tr></thead>
    ...
    <script src="{{ asset('js/traceability-tr.js') }}"></script>
</body>
</html>
